...
$(function(){
    ...
    $("select").change(function(){
        ...
        parametros_pesquisa[selecao]= $(this).val();
    ...
    if(window.localStorage["quantidade"]){
        ...
        /* como as variaveis de localstorage são do tipo string e a quantidade não,
           é necessário realizar o parseInt()
        */
    }
